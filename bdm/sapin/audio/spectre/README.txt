...
Pour compiler un fichier, il faut mettre le fichier dans un des dossier dans "/src" (par exemple : "Examples").
L'execution de la commande "./waf", le compilera et le placera dans le dossier "<racine>/build/src/<dossier contenant le fichier>.
