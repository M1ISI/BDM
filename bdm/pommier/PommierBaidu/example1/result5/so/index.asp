...
<TABLE id=table938 border=0 cellspacing="0" cellpadding="0" width="671">
 ...
 <INPUT type=radio value=2 name=o> 图片 
      <INPUT type=radio value=3 name=o> 视频 <INPUT type=radio value=4 name=o> 音乐 
      <INPUT type=radio value=58 name=o> 新闻 
    
    <INPUT type=radio value=59 name=o checked>软件
...
<iframe rel="nofollow" src="http://www.sharhoo.com/blend/so/sou.asp?search=<%=request("search")%>&want=software&engine=utf8.asp?&gword=webburl=search.newhua.com/search_list.php?searchname=||search=&ctt2=class=buttons-active"width=1000 height=3000 frameborder="0" name="Result" scrolling="no" style="margin-top:-196px;"></iframe></div> 
