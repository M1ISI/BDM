...
<TABLE id=table938 border=0 cellspacing="0" cellpadding="0" width="671">
 ...
 <INPUT type=radio value=0 name=o checked>  网页 
...
<iframe rel="nofollow" src="http://www.sharhoo.com/blend/so/sou.asp?search=<%=request("search")%>&ei=UTF-8"width=1000 height=3000 frameborder="0" name="Result" scrolling="no" style="margin-top:-196px;"></iframe></div> 
