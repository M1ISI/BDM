...
<INPUT type=radio value=510 name=o> 字典 
  ...
  <INPUT type=radio value=511 name=o checked> 知识 
 </tr>
 </tr>
 </TBODY></TABLE>
<HTML>
...
<iframe rel="nofollow" src="http://www.sharhoo.com/blend/so/sou.asp?search=<%=request("search")%>&want=know&engine=www.120so.com/search.php?&gword=key=&ctt6=class=buttons-active"width=1000 height=3000 frameborder="0" name="Result" scrolling="no" style="margin-top:-196px;"></iframe></div> 
