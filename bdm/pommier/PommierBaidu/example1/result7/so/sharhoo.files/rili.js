...
this.month = i
this.day = offset + 1}
function YYMMDD() {    return('<font style="font-size:13px">'+SY+'年'+(SM+1)+'月'+SD+'日</font>')}
function weekday(){
...
var sFtv = new Array("0101*元旦","0214 情人节","0308 妇女节","0312 植树节","0401 愚人节","0501 劳动节","0504 青年节","0512 护士节","0601 儿童节","0621 父亲节","0701 中共诞辰","0801 建军节","0910 教师节","1001*国庆节","1031 万圣节","1108 记者日","1225 圣诞节")
...
if (mm < 10) hh+='0'
hh += mm
var str='<a href="js/day.htm" title="查看万年历_星座运程_历史上的今天" target="_blank" style="font-size:13px;font-family: Arial, Helvetica, sans-serif;">'+YYMMDD()+'<br>'+solarDay()+'<br>'+weekday()+" <span id=ClockTime style='font-weight:bold;'>"+hh+'</span></a> <a href="javascript:clock()" target=_self  title=点击设置闹钟 style="font-size:13px;color:#00389C;">闹钟</a>'
if(t==1) document.getElementById('rili').innerHTML=str
else document.write(str)}
function clock() {window.open('clock.htm','time','left='+(screen.width-320)+',height=310,width=305,status=no,toolbar=no,menubar=no')}
function start() {setInterval('refreshCalendarClock()',1000);}
