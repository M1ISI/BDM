...
<TABLE id=table938 border=0 cellspacing="0" cellpadding="0" width="671">
 ...
 <INPUT type=radio value=2 name=o> 图片 
      ...
      <INPUT type=radio value=58 name=o checked> 新闻 
...
<iframe rel="nofollow" src="http://www.sharhoo.com/blend/so/sou.asp?search=<%=request("search")%>&want=news"width=1000 height=3000 frameborder="0" name="Result" scrolling="no" style="margin-top:-196px;"></iframe></div> 
