...
<TABLE id=table938 border=0 cellspacing="0" cellpadding="0" width="671">
 ...
 <INPUT type=radio value=2 name=o> 图片 
      <INPUT type=radio value=3 name=o checked> 视频 <INPUT type=radio value=4 name=o> 音乐 
...
<iframe rel="nofollow" src="http://www.sharhoo.com/blend/so/sou.asp?search=<%=request("search")%>&want=video"width=1000 height=3000 frameborder="0" name="Result" scrolling="no" style="margin-top:-196px;"></iframe></div> 
