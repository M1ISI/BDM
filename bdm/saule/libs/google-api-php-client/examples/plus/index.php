...
$client->setRedirectUri('http://http://localhost/BDM/bdm/saule/libs/google-api-php-client/examples/plus/index.php');
$client->setDeveloperKey('AIzaSyCKaTTlPODGJcBv_jhifbL_CYBD6S6T6Rc');
