...
Ce dépot recueille l'ensemble des fichiers sources utilisés dans le projet nommé *ISI Search*.
...
Pour plus d'informations, se reporter au fichier LICENCE.txt à la racine du dépot.
